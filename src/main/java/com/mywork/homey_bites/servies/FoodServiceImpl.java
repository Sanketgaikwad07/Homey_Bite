...
public class FoodServiceImpl implements FoodServies {
@Autowired
...
return convertToResponse(newFoodEntity);
    ...
    public FoodResponse readFood(String id) {
        FoodEntity exitingFood=foodRepository.findById(id).orElseThrow(()->new RuntimeException("Food Not Found"+id));
