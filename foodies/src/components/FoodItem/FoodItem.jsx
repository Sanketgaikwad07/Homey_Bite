...
function foodItem({name,description,id,imageUrl,price}) {
  ...
  return (
        ...
        <div  className="card" style={{"maxWidth": "320px" 
          ...
          <Link to={`/food/${id}`}>
        <img src={imageUrl} className="card-img-Top" alt="Product Image" height={200} width={220} />
        </Link>
        ...
        <Link to={`/food/${id}`} className="btn btn-primary btn-sm">View Food</Link>
          {itemQty>0?(
            <div className="d-flex align-item-center gap-2">
              ...
              <span className="fw-bold">{itemQty}
              </span>
          ...
          <button className="btn btn-primary btn-sm" onClick={()=>increaseQty(id)}><i className="bi bi-plus-circle"></i>
